...
回调函数无需修改 LightningModule 即可为训练过程增添功能。它们用于处理诸如检查点保存、提前停止以及日志记录等**非核心逻辑**。
...
### 6. 随机权重平均法（StochasticWeightAveraging，SWA）
...
- 回调 API：https://lightning.ai/docs/pytorch/stable/extensions/callbacks.html
- 内置回调功能：https://lightning.ai/docs/pytorch/stable/api_references.html#callbacks
- 示例代码：https://github.com/Lightning-AI/pytorch-lightning/tree/master/examples/callbacks
