...
- **HuggingFace 集成**：https://docs.wandb.ai/guides/integrations/huggingface
- **PyTorch Lightning 集成**：https://docs.wandb.ai/guides/integrations/lightning
- **Keras 集成**：https://docs.wandb.ai/guides/integrations/keras
