...
# Weights & Biases：机器学习实验跟踪与MLOps工具

## 何时使用该工具

当您需要以下功能时，可使用Weights & Biases（W&B）：
- 通过自动指标记录功能**跟踪机器学习实验**
- 在实时仪表板中**可视化训练过程**
- **对比不同超参数及配置下的实验结果**
- 利用自动化扫描功能**优化超参数设置**
- 通过版本控制和溯源功能**管理模型注册表**
- 基于团队工作空间实现**机器学习项目的协作开发**
- 对**数据集、模型、代码等工件**进行带有溯源信息的跟踪

**用户规模**：20万+机器学习从业者 | **GitHub星标数**：1.05万+ | **集成数量**：100+个
