...
- 首个Token生成时间的中位数：`histogram_quantile(0.5, vllm_time_to_first_token_seconds_bucket)`
- 首个Token生成时间的99%分位数：`histogram_quantile(0.99, vllm_time_to_first_token_seconds_bucket)`
