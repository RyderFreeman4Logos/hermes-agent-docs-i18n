...
|---|---|
| 来源 | 内置（默认已安装） |
| 路径 | `skills/software-development\test-driven-development` |
| 版本 | `1.1.0` |
| 创建者 | Hermes Agent（基于 obra/superpowers 改编） |
| 许可证 | MIT |
| 支持平台 | linux、macos、windows |
| 标签 | `testing`、`tdd`、`development`、`quality`、`red-green-refactor` |
| 相关技能 | [`系统化调试`](/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging)、[`子代理驱动开发`](/docs/user-guide/skills/optional/software-development/software-development-subagent-driven-development) |
...
首先编写测试用例，然后观察其失败情况，最后编写最简化的代码来使测试通过。

**核心原则：** 如果你没有亲眼看到测试失败，就无法确定该测试是否针对正确的功能进行验证。

**违背规则的文字表述，就等同于违背了规则的精神。**
