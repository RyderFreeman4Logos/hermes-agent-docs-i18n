...
ASCII 艺术相关工具：pyfiglet、cowsay、boxes、图像转 ASCII。

## 技能元数据

| | |
|---|---|
| 来源 | 可选 — 通过 `hermes skills install official/creative/ascii-art` 安装 |
...
提供多种工具，可满足不同的 ASCII 艺术创作需求。所有工具均为本地 CLI 程序或免费的 REST API — 无需 API 密钥。

## 工具 1：文本横幅（pyfiglet — 本地版）

可将文本渲染为大型 ASCII 艺术横幅，内置 571 种字体。
