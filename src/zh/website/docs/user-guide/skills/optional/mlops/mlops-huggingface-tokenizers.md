...
- **[训练指南](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/training.md)** – 如何训练自定义分词器、配置训练器以及处理大规模数据集
...
- **[流程组件](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mlops/huggingface-tokenizers/references/pipeline.md)** – 包括规范化器、预分词器、后处理模块及解码器
