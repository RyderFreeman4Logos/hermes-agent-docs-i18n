...
W&B：用于记录机器学习实验、执行参数扫描、管理模型注册表以及提供可视化控制面板。

## 技能元数据

| | |
|---|---|
| 来源 | 可选 —— 通过命令 `hermes skills install official/mlops/weights-and-biases` 安装 |
...
- **对比不同超参数及配置下的实验结果**
- 利用自动化的参数扫描功能**优化超参数**
- 通过版本控制和历史追踪功能**管理模型注册表**
- 基于团队工作空间实现**机器学习项目的协作**
- 对**数据集、模型、代码等成果**进行带有历史追溯的跟踪
**用户数量**：20万+ 机器学习从业者 | **GitHub星标数**：1.05万+ | **集成数量**：100+ 
...
- **学术版**：面向学生和研究人员免费
- **团队版**：50美元/席位/月，支持私有项目，存储空间无限
- **企业版**：定制化定价，提供本地部署选项

## 资源链接

- **文档**：https://docs.wandb.ai
- **GitHub 仓库**：https://github.com/wandb/wandb（评分超10,500星）
