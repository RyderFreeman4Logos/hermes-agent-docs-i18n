...
| 模型 | CLAP 分数 | 生成时间（10秒） | 显存需求 |
|-------|------------|----------------------|----------|
| musicgen-small | 0.35 | 约5秒 | 2GB |
| musicgen-medium | 0.42 | 约15秒 | 4GB |
| musicgen-large | 0.48 | 约30秒 | 8GB |
| musicgen-melody | 0.45 | 约15秒 | 4GB |
| musicgen-stereo-medium | 0.41 | 约18秒 | 5GB |
